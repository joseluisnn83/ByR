...
public class SingletonBroadcastReceiver {
	...
	/*
	 * Me creo las constantes para el broadcast entre InformesScreenActivity y PestanyaSemanalActivity, Mensual; ... 
	 */
	public final String FILTRO_CONCEPTOS_APLICAR = "com.joseluisnn.tt.APPLY_FILTER";
