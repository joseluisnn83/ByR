...
public class CalendarMonthView extends LinearLayout {
	...
	private void initDayCaptions(final Context context) {
		...
		if (DateHelper.isMondayFirst()) {
			...
			dayCaptions[0] = getResources().getString(R.string.mycalendar_short_domingo);
			DateHelper.increment(weekDay);
			dayCaptions[1] = getResources().getString(R.string.mycalendar_short_lunes);
			DateHelper.increment(weekDay);
			dayCaptions[2] = getResources().getString(R.string.mycalendar_short_martes);
			DateHelper.increment(weekDay);
			dayCaptions[3] = getResources().getString(R.string.mycalendar_short_miercoles);
			DateHelper.increment(weekDay);
			dayCaptions[4] = getResources().getString(R.string.mycalendar_short_jueves);
			DateHelper.increment(weekDay);
			dayCaptions[5] = getResources().getString(R.string.mycalendar_short_viernes);
			DateHelper.increment(weekDay);
			dayCaptions[6] = getResources().getString(R.string.mycalendar_short_sabado);
			DateHelper.increment(weekDay);
		}
		/*
