...
import com.joseluisnn.Graphics.GraphicsActivity;
...
public class PrincipalScreenActivity extends Activity {
	...
	private ImageView iv_titulo_logo;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		iv_titulo_logo = (ImageView) findViewById(R.id.PrincipalScreenActivity_iv_titulologo);
		...
		/*
		 *  Compruebo si el dispositivo esta en inglés o no para el título
		 *  ponerlo en inglés o dejarlo en castellano
		 */
		if(getResources().getConfiguration().locale.getLanguage().equals("en")){
			iv_titulo_logo.setImageDrawable(getResources().getDrawable(R.drawable.titulo_logo_en));
		}
		...
		if (preferenceConfiguracionPrivate.contains(singleton_csp.KEY_CUENTA)) {
			...
			/*
			 * La moneda seleccionada por defecto será el euro hasta que el usuario la modifique
			 * 0: euro , 1 : dolar , 2 : libra, etc		  
			 */
			prefEditorConfiguracion.putInt(
