...
public class ConfigurationActivity extends Activity {
	...
	private Dialog crearDialogoTipoMoneda() {
		final String[] items = {
				...
				getResources().getString(R.string.moneda_mexico),
				getResources().getString(R.string.moneda_argentina),
				getResources().getString(R.string.moneda_bolivia),
				getResources().getString(R.string.moneda_brasil), 
				getResources().getString(R.string.moneda_chile),
				getResources().getString(R.string.moneda_colombia),
				getResources().getString(R.string.moneda_paraguay),
				getResources().getString(R.string.moneda_peru),
				getResources().getString(R.string.moneda_uruguay),
				getResources().getString(R.string.moneda_venezuela) };
